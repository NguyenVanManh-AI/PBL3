    ...
    public partial class UpdateBookTitle : Form
    {
            ...
            else if (dataGridView2.SelectedRows.Count > 0)
            {
                if (MessageBox.Show("Are you sure you want to delete?(Y/N)", "Delete", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                {
                    try
                    {
                        ...
                        cls.LoadData2DataGridView(dataGridView1, "select btt.*,au.first_name AS authorfname,au.last_name AS authorlname,pub.name AS tennxb ,ca.name AS tenlinhvuc from book_titles as btt left outer JOIN authors as au on btt.author_id = au.id left outer join publishers as pub on btt.publisher_id = pub.id left outer join categorys as ca on btt.category_id = ca.id WHERE 1 = 1");
                        txtId.Text = "";
                        txtTitle.Text = "";
                        txtAu.Text = "";
                        txtPub.Text = "";
        ...
        private void comboBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            else if (cbbS.Text == "Author")
            {
                dataGridView2.Hide();
                dataGridView3.Show();
                cls.LoadData2DataGridView(dataGridView3, "select * from authors");
                dataGridView4.Hide();
                dataGridView5.Hide();
            }
            else if (cbbS.Text == "Publisher")
            {
                ...
                dataGridView3.Hide();
                dataGridView4.Show();
                cls.LoadData2DataGridView(dataGridView4, "select * from publishers");
                dataGridView5.Hide();
            }
            else if (cbbS.Text == "Category")
            {
                ...
                dataGridView4.Hide();
                dataGridView5.Show();
                cls.LoadData2DataGridView(dataGridView5, "select * from categorys");
            }
        }
        ...
        private void dataGridView2_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            txtAu.Text = dataGridView2.Rows[e.RowIndex].Cells[2].Value.ToString(); ;
            txtPub.Text = dataGridView2.Rows[e.RowIndex].Cells[4].Value.ToString(); ;
            txtCate.Text = dataGridView2.Rows[e.RowIndex].Cells[3].Value.ToString(); ;
            txtDes.Text = dataGridView2.Rows[e.RowIndex].Cells[5].Value.ToString(); ;
            txtUpdate.Text = dataGridView2.Rows[e.RowIndex].Cells[9].Value.ToString(); ;
            txtCreate.Text = dataGridView2.Rows[e.RowIndex].Cells[8].Value.ToString(); ;
            txtDate.Text = dataGridView2.Rows[e.RowIndex].Cells[6].Value.ToString(); ;
            txtPage.Text = dataGridView2.Rows[e.RowIndex].Cells[7].Value.ToString(); ;
        }
    }
}
